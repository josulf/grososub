...
- (void) testParseString
{
	...
	STAssertTrue([[[sl getStyleAtIndex:0] description] isEqualToString:@"Style: Gurren,FrancophilSans,33,&H00FFFFFF,&H00FFFFFF,&H0A000000,&H96000000,-1,0,0,0,85.00,100.00,0.00,0.00,1,1.50,0.50,2,20,20,20,0"],
				 @"Two events aren't the same");
	STAssertTrue([[[sl getStyleAtIndex:1] description] isEqualToString:@"Style: TS,DFMincho-Edit,55,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,83.00,100.00,0.00,0.00,1,0.00,2.30,2,10,10,10,1"],
				 @"Two events aren't the same");
	STAssertTrue([[[sl getStyleAtIndex:2] description] isEqualToString:@"Style: TS2,DFMincho-Edit,55,&H00000000,&H000000FF,&H00D7D7D7,&H00000000,0,0,0,0,83.00,100.00,0.00,0.00,1,1.50,0.00,2,10,10,10,1"],
				 @"Two events aren't the same");
