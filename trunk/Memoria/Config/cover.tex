...
\tb{0.8}{0.50}{0.22}{\huge ASS formatuko azpititulu editorea Mac OS X sistemarako}                       % titulua
\tb{0.8}{0.50}{0.37}{\Large \worktype}                         % KBP edo Tesia ote den
\tb{0.5}{0.50}{0.40}{\today}                                   % sortze data (aldatu textu finkoaz)
\tb{0.8}{0.50}{0.45}{\large Josu López Fernández}                           % autorearen izena
\tb{0.8}{0.50}{0.50}{\large \textit{Gainbegiralea:}\\ Juan Antonio Pereira Varela} % gainbegiralearen izena
